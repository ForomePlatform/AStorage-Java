...
[source]
----
curl -X POST "localhost:8080/ingestion/fasta?arrayName=<arr_name>&dataPath=<data_url>&metadataPath=<metadata_url>"
----

To query data:
[source]
----
curl "localhost:8080/query/fasta?arrayName=<arr_name>&sectionName=<sec_name>&startPos=<start_pos>&stopPos=<stop_pos>"
----
====
