...
[source]
----
curl -X POST "localhost:8080/ingestion/gnomad?dataUrl=<data_url>&sourceType=<src_type>&refBuild=<ref_build>"
----
...
[source]
----
curl -X POST "localhost:8080/ingestion/spliceai?dataPath=<data_path>&normalize=<normalize_boolean>&refBuild=<ref_build>"
----
...
[source]
----
curl -X POST "localhost:8080/ingestion/clinvar?dataPath=<data_path>&dataSummaryPath=<data_summary_path>&refBuild=<ref_build>"
----
